...
import com.baidu.idl.face.sample.adapter.CameraPagerAdapter;
import com.baidu.idl.face.sample.api.FaceApi;
import com.baidu.idl.face.sample.callback.IFaceRegistCalllBack;
import com.baidu.idl.face.sample.callback.ILivenessCallBack;
import com.baidu.idl.face.sample.manager.FaceLiveness;
...
import com.baidu.idl.face.sample.view.BaseCameraView;
        ...
        if (id == R.id.go_btn) {
            ...
            if (editable != null) {
                ...
                if ("0".equals(nameResult)) {
                    ...
                    // 隐藏键盘
                    com.baidu.idl.face.sample.utils.Utils.hideKeyboard((Activity) mContext);
                    if (mCamera != null) {
