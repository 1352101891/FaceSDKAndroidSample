...
import com.baidu.idl.sample.ui.IminectPassActivity;
import com.baidu.idl.sample.ui.OrbbecMiniPassActivity;
import com.baidu.idl.sample.ui.OrbbecProPassActivity;
import com.baidu.idl.sample.ui.PassActivity;
...
public class ApiActivity extends Activity implements View.OnClickListener,OnImportListener {
    ...
    public void onClick(View view) {
        ...
        if ( GlobalSet.FACE_AUTH_STATUS == 0){
            if (i == R.id.layout_register) {
                registerPerson();
            }else if (i == R.id.layout_manager) {
            }else if (i == R.id.layout_pass) {
                Intent intent=null;
    ...
    private void initView() {
        ...
        layout_manager=findViewById(R.id.layout_manager);
