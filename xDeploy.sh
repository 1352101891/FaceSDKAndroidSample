...
BDFACE_WORKSPACE="${BDFACE_WORKSPACE_DIR}/FaceSDKAndroidSample"
...
function BDFaceCopyProducts()
{
    ...
    facelibrarysopath=$workpath"/facelibrary/build/intermediates/bundles/release/jni/*"
    facelibraryjarspath=$workpath"/facelibrary/build/intermediates/bundles/release/libs/*"
    facelibraryclassspath=$workpath"/facelibrary/build/intermediates/bundles/release/classes.jar"

    ls $workpath"/facelibrary/build/intermediates/bundles/release/jni/armeabi-v7a/"
